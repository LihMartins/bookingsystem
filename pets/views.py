...
The `register_pet` view handles the form submission for adding new pets, ensuring
that only authenticated users can register a pet and associating the pet with the
current user. The `pet_list` view retrieves and displays a list of all pets
belonging to the logged-in user, allowing them to manage and view their pets
within the system.
"""
