"""
This module handles user authentication processes.

It includes login, logout, and registration. It provides views
for managing user sessions and ensuring secure access to the
system. The module integrates with Django's built-in
authentication system and extends it with custom user
registration forms.

Functions:
- login_user: Authenticates and logs in a user based on
provided credentials.
- logout_user: Logs out the currently logged-in user and
redirects to the homepage.
- register_user: Registers a new user, logs them in, and
redirects to the homepage.
"""
...
def login_user(request):
    ...
    If the request method is POST, this function attempts to authenticate
    the user with the provided username and password. If successful, the
    user is logged in and redirected to the homepage. If authentication
